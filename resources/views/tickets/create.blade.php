				...
				<div class="card-body">
					...
					<div class="row">
						<div class="form-group col-12 col-md-12">
							<button type="button" class="btn btn-block btn-sm btn-primary" data-toggle="modal" data-target="#myModal"><i class="far fa-user"></i> Ingresar datos
						   </button>				   
						</div>
					</div>
					<hr>
		...
		<form action="{{route('people.store')}}" method="post">
			...
			<div class="modal-body">
				<div class="form-group">
					...
					<input type="text" name="firstName" class="form-control" >{{ old ('firstName') }}</input>
				</div>
				<div class="form-group">
					<label for="">Segundo Apellido</label>
					<input type="text" name="lastName" class="form-control" >{{ old ('lastName') }}</input>
				</div>							
				<div class="form-group">
				...
				<div class="form-group">
					...
					<input type="text" name="identity_card" class="form-control">{{ old ('identity_card') }}</input>
				</div>
				<div class="form-group">
					<label for="">Expedido</label>
						<input type="text" name="issued" class="form-control">{{ old ('issued') }}</input>
				</div>
			</div>
